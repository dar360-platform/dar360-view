...
export const TenantAuth = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.info(isSignUp ? "Tenant registration coming soon!" : "Tenant login coming soon!", {
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground font-body text-sm md:text-base">
              {isSignUp 
                ? "Find your home and manage your tenancy effortlessly" 
                : "Sign in to view contracts, payments, and maintenance"}
            </p>
          </div>
          ...
          <div className="bg-card border border-border/50 rounded-2xl p-6 md:p-8 shadow-soft">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="firstName" placeholder="Sarah" className="h-12" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="lastName" className="text-sm font-medium">Last Name</Label>
                      <Input id="lastName" placeholder="Thompson" className="h-12" required />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="emiratesId" className="text-sm font-medium">Emirates ID (Optional)</Label>
                    <Input id="emiratesId" placeholder="784-XXXX-XXXXXXX-X" className="h-12" />
                  </div>
                </>
              )}
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="tenant@example.com" className="h-12" required />
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground font-body">
              Looking to rent? Browse properties and apply directly through your agent.
            </p>
          </div>
        </motion.div>
      </main>
